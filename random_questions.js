var quoteArray = [
  ...
  ["Did you experience illegal substences? \n What do you keep from that?"],
  ["What kind of death scares you most?"],
  ["If you could change the year of your birth which would you pick?"],
  ["Do you belive ghosts exists? \n What about aliens?"],
  ["How long will it take for our civilization to collapse? \n What would you do if we are still alive when it happens?"],
  ["Do you think we can stop the global warming? \n Will we?"],
  ["Dog or cat?"],
  ["Phò or Ramen?"],
  ["Did you ever had a pet? \n What was it? \n What was it's name?"],
  ["What does it mean for you to be a feminist? \n Can you search and read the definition of it? \n Do you relate to it?"],
  ["Would you use a selfdriving car without human driver? \n Without pedals and steering wheel?"],
  ["What is the hardest habits you decided to get ride of? \n Why? \n Do you still stand it?"],
  ...
  ["Did you ever made a trip only by yourself? \n Where was it? \n How long did it last?"],
  ...
  ["Do you clean and tidy your appartment before going on holidays? \n Why?"],
